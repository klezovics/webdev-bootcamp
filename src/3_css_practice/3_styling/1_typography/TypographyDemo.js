...
const TypographyDemo = () => (
  <>
    ...
    <hr />
    <FarAwayLetterSpacingDiv>
      This text has wide-spaced letters!
    </FarAwayLetterSpacingDiv>
    <hr />
    <TextWithBigLineHeightDiv>
      This text has a big line height. More more. Lorem ipsum
      fdhfjdhfdjhfdjhfjdhfdfdf fdfdfdfdfdfdfdfdfdf
    </TextWithBigLineHeightDiv>
    <hr />
    ...
    <BoxWithTextOverflowProperty>
      Some text that is too long to fit in the box. More text. More text. More
    ...
    <hr />
    <TextWithMergedWhiteSpaces>
      This text has a lot of whitespace merged!
    </TextWithMergedWhiteSpaces>
    <hr />
    <SmallBox>
      <TextWithBrokenWords>Text with some broker wods </TextWithBrokenWords>
    </SmallBox>
    <hr />
    <TextWithBigWordSpacing>
      This text has big words spacing
    </TextWithBigWordSpacing>
    <hr />
  </>
);
