JavaScript is a dynamically-typed language, which means that variables can hold values of different types throughout their lifetime. JavaScript has several built-in types, which include:
